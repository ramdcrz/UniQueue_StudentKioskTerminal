...
function StatusContent() {
  ...
  // Find the ticket across the real-time synced tickets
  const ticket = tickets.find(t => t.id === ticketId && t.departmentId === deptId);
    ...
    return (
      <div className="min-h-screen bg-[#F4F4F7] flex items-center justify-center p-6">
        <Card className="glass p-8 text-center space-y-4 rounded-[2rem] max-w-sm">
          ...
          <p className="text-muted-foreground font-medium">Checking global sync... if this persists, the ticket may have expired.</p>
          <div className="pt-4">

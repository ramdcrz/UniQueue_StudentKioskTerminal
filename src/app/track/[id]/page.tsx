  ...
  return (
    <div className="min-h-screen bg-[#F4F4F7] p-6 flex flex-col items-center justify-center space-y-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <Card className="liquid-glass rounded-[2.5rem] p-8 space-y-8 shadow-2xl overflow-hidden">
          <div className="flex justify-between items-start">
            ...
            <Badge variant="outline" className="px-3 py-1 rounded-full font-bold uppercase">
              {ticket.status}
            </Badge>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white/50 p-4 rounded-2xl border">
              ...
              <span className="text-2xl font-black text-secondary">~{waitingAhead * 5}m</span>
            </div>
          </div>
          ...
          <Link href="/" className="block">
            <Button variant="outline" className="w-full rounded-2xl border-2 font-bold text-muted-foreground gap-2">
